...
export class TagRangeVisual {
  ...
  public update(players: Player[]): void {
    ...
    for (const player of players) {
      ...
      // Update sphere position to match player position
      // Player position is at ground level, sphere should be centered at player model center
      sphere.position.set(
        player.position.x,
        player.position.y, // Use ground position (sphere will be centered at ground)
        player.position.z
      );
    }
  }
