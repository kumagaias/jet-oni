...
- [ ] 13. Devvit Realtime統合

  - [ ] 13.1 RealtimeSyncManagerクラスを作成
  ...
  - [ ] 13.2 Realtimeメッセージ送信を実装
    - sendPlayerStateメソッドを実装
    - スロットリング (最大60回/秒)を実装
    - メッセージフォーマットを定義
    - _要件: 4.2, 8.4_

  - [ ] 13.3 Realtimeメッセージ受信を実装
