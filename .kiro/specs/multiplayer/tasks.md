...
- [ ] 2. GameSyncManagerの実装
  - [ ] 2.1 GameSyncManagerクラスを作成
...
- [ ] 5. main.tsの更新
  - [ ] 5.1 GameAPIClientを初期化
    - GameAPIClientインスタンスを作成
    - UIMenuに渡す
    - _要件: 1.4_
  - [ ] 5.2 GameSyncManagerを統合
...
- [ ] 6. サーバーAPIの更新
  - [ ] 6.1 /api/game/:id/updateエンドポイントを追加
    - POST /api/game/:id/updateを実装
    - プレイヤー状態を受信
    - Redisに保存
    - 状態を検証
    - _要件: 4.1, 4.2, 9.1, 9.2_
  - [ ] 6.2 /api/game/listエンドポイントを更新
...
- [ ] 7. RedisStorageの更新
  - [ ] 7.1 updatePlayerメソッドを実装
    - プレイヤー状態をRedisに保存
    - TTLを設定 (1時間)
    - _要件: 4.2, 8.5_
  - [ ] 7.2 listGamesメソッドを実装
    - アクティブなゲームIDを取得
    - 各ゲームの状態を取得
    - 参加可能なゲームのみフィルタ
    - _要件: 2.1, 2.2_
