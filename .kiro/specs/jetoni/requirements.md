...
**ユーザーストーリー:** 鬼として、逃げる側の位置を一時的に確認したい。

#### 受入基準

1. WHEN プレイヤーが鬼になってから30秒経過する, THEN THE システム SHALL ビーコン能力を有効化する
2. WHEN 鬼がBキーを押す, THEN THE システム SHALL ビーコンを起動する
3. WHEN ビーコンが起動する, THEN THE システム SHALL 10秒間全プレイヤーの位置を表示する
4. WHEN ビーコンが終了する, THEN THE システム SHALL 30秒間のクールダウンを開始する
5. WHEN クールダウン中である, THEN THE システム SHALL ビーコンの使用を無効化する
